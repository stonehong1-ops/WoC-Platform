      ...
      <section className="py-24 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/30 flex flex-col group hover:border-primary/40 transition-colors shadow-sm">
            ...
            <h3 className="font-headline font-bold text-xl mb-3">{t('hub.service1_title')}</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-6">{t('hub.service1_desc')}</p>
          </div>
          {/* Service 2 */}
          <div className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/30 flex flex-col group hover:border-primary/40 transition-colors shadow-sm">
            <div className="w-12 h-12 bg-primary-container rounded-lg flex items-center justify-center mb-6 text-primary">
            ...
            <h3 className="font-headline font-bold text-xl mb-3">{t('hub.service2_title')}</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-6">{t('hub.service2_desc')}</p>
          </div>
          {/* Service 3 */}
          <div className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/30 flex flex-col group hover:border-primary/40 transition-colors shadow-sm">
            <div className="w-12 h-12 bg-primary-container rounded-lg flex items-center justify-center mb-6 text-primary">
            ...
            <h3 className="font-headline font-bold text-xl mb-3">{t('hub.service3_title')}</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-6">{t('hub.service3_desc')}</p>
          ...
          <div className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/30 flex flex-col group hover:border-primary/40 transition-colors shadow-sm">
            ...
            <h3 className="font-headline font-bold text-xl mb-3">{t('hub.service4_title')}</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-6">{t('hub.service4_desc')}</p>
            <button className="mt-auto border border-primary text-primary hover:bg-primary hover:text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all">
              {t('hub.service4_btn')}
            </button>
          </div>
      ...
      <section className="py-24 bg-surface-container-low overflow-hidden">
        ...
        <div className="flex gap-6 px-6 overflow-x-auto hide-scrollbar snap-x snap-mandatory">
          ...
          <div className="min-w-[300px] md:min-w-[320px] snap-start bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm group">
            ...
            <div className="p-6">
              <span className="text-[10px] font-bold text-primary px-2 py-1 bg-primary-container rounded mb-2 inline-block uppercase">{t('hub.item_badge_exclusive')}</span>
              <h4 className="font-headline font-bold text-lg">{t('hub.item1_title')}</h4>
              <p className="text-on-surface-variant text-sm mt-1">{t('hub.item1_desc')}</p>
            </div>
          </div>
          {/* Item 2 */}
          <div className="min-w-[300px] md:min-w-[320px] snap-start bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm group">
            ...
            <div className="p-6">
              <span className="text-[10px] font-bold text-primary px-2 py-1 bg-primary-container rounded mb-2 inline-block uppercase">{t('hub.item_badge_new')}</span>
              <h4 className="font-headline font-bold text-lg">{t('hub.item2_title')}</h4>
              <p className="text-on-surface-variant text-sm mt-1">{t('hub.item2_desc')}</p>
            </div>
          </div>
          {/* Item 3 */}
          <div className="min-w-[300px] md:min-w-[320px] snap-start bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm group">
            ...
            <div className="p-6">
              <span className="text-[10px] font-bold text-primary px-2 py-1 bg-primary-container rounded mb-2 inline-block uppercase">{t('hub.item_badge_limited')}</span>
              <h4 className="font-headline font-bold text-lg">{t('hub.item3_title')}</h4>
              <p className="text-on-surface-variant text-sm mt-1">{t('hub.item3_desc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 container mx-auto px-6 border-b border-outline-variant/10">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3 text-center lg:text-left">
            <span className="text-primary font-bold tracking-widest text-xs uppercase">{t('hub.help_subtitle')}</span>
            <h2 className="font-headline font-bold text-3xl mt-2 mb-6 text-on-surface">{t('hub.help_title')}</h2>
        ...
        <div className="bg-surface-container-highest rounded-2xl overflow-hidden flex flex-col lg:flex-row shadow-lg border border-outline-variant/20">
          <div className="flex-1 min-h-[400px] relative overflow-hidden">
            ...
            <div className="absolute top-4 left-4 inline-flex items-center gap-2 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full border border-outline-variant/30 shadow-sm">
              ...
              <span className="text-[10px] font-bold text-on-surface uppercase">{t('hub.status_open')}</span>
            </div>
          </div>
          <div className="p-10 lg:p-16 lg:max-w-md bg-surface flex flex-col justify-center">
            <h2 className="font-headline font-bold text-3xl mb-8 text-on-surface">{t('hub.visit_title')}</h2>
            <div className="space-y-8">
              <div className="flex gap-4">
                <span className="material-symbols-outlined text-primary">map</span>
                <div>
                  <h4 className="font-bold text-sm text-on-surface">{t('hub.address_label')}</h4>
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    {t('hub.address_line1')}<br/>
                    {t('hub.address_line2')}<br/>
                    {t('hub.address_line3')}
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm text-on-surface">{t('hub.hours_label')}</h4>
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    {t('hub.hours_weekdays')}<br/>
                    {t('hub.hours_weekends')}
                  </p>
                </div>
              </div>
