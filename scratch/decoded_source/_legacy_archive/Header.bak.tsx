    ...
    <header className="fixed top-0 w-full z-50 bg-[#FAF8FF]/80 backdrop-blur-md border-b border-slate-100 h-16 px-3 flex items-center justify-between">
      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <span className="material-symbols-outlined text-on-surface !text-[18px]" data-icon="notifications">notifications</span>
            {totalNotiCount > 0 && (
              <span className="absolute top-0 right-0 flex h-3 w-3 items-center justify-center rounded-full bg-error text-[7px] font-black text-white outline outline-1 outline-white animate-in zoom-in">
