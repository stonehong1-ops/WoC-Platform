...
const SOCIAL_LINK_KEYS = ["facebook", "instagram", "whatsapp"];
...
function hasPublicChange(before, after) {
    if (!before)
        return true;
 ...
 */
exports.syncPublicProfile = (0, firestore_1.onDocumentWritten)({
    document: "users/{uid}",
    region: "us-central1",
}, async (event) => {
    var _a, _b, _c, _d;
...
//# sourceMappingURL=syncPublicProfile.js.map