      ...
      <main className="py-6 px-4 max-w-7xl mx-auto space-y-10 pb-24">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {/* Global Stats (Tastemakers ?꾨옒濡??대룞) */}
        ...
        {photogenicPost && (
          <section className="relative overflow-hidden rounded-[32px] shadow-xl group cursor-pointer" onClick={() => window.location.href = '/gallery'}>
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <span className="px-3 py-1 bg-white/20 text-white text-[10px] font-bold uppercase tracking-widest rounded-full mb-2 inline-block backdrop-blur-md border border-white/20">?벝 Photogenic Last Night</span>
        ...
        {videogenicPost && (
          <section className="relative overflow-hidden rounded-[32px] shadow-xl group cursor-pointer" onClick={() => window.location.href = '/gallery'}>
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <span className="px-3 py-1 bg-white/20 text-white text-[10px] font-bold uppercase tracking-widest rounded-full mb-2 inline-block backdrop-blur-md border border-white/20">?렗 Videogenic This Month</span>
