...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "sans":        ["Plus Jakarta Sans", "Inter", "Pretendard Variable", "Pretendard", "sans-serif"],
        "headline":    ["Plus Jakarta Sans", "Pretendard Variable", "Pretendard"],
        "body":        ["Inter", "Pretendard Variable", "Pretendard"],
        "label":       ["Inter", "Pretendard Variable", "Pretendard"],
        "title-md":    ["Plus Jakarta Sans", "Pretendard Variable", "Pretendard"],
        "label-sm":    ["Inter", "Pretendard Variable", "Pretendard"],
        "body-md":     ["Inter", "Pretendard Variable", "Pretendard"],
        "headline-lg": ["Plus Jakarta Sans", "Pretendard Variable", "Pretendard"],
        "display-xl":  ["Plus Jakarta Sans", "Pretendard Variable", "Pretendard"],
        "label-xs":    ["Inter", "Pretendard Variable", "Pretendard"],
      },
      fontSize: {
