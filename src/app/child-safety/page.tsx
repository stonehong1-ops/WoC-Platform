...
export default function ChildSafetyPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-on-surface">
      <h1 className="text-3xl font-black mb-8">Tango World Child Safety Standards</h1>
      
      <div className="space-y-12">
        {/* English Section */}
        <section className="space-y-6 border-b border-on-surface/10 pb-10">
        ...
        <section className="space-y-6">
          ...
          <p className="leading-relaxed text-on-surface/80">
            Tango World는 아동 성적 학대물(CSAM) 및 아동 성적 학대 및 착취(CSAE) 콘텐츠를 생성, 공유, 전송, 홍보 또는 조장하는 모든 행위를 명시적으로 금지합니다.
            이 무관용 정책은 다음에 적용됩니다:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-on-surface/80">
            <li>아동에 대한 성적 학대, 착취 또는 부적절한 묘사가 포함된 모든 자료.</li>
            <li>성적 착취 또는 학대를 목적으로 미성년자와 관계를 맺으려는 시도를 포함한 온라인 그루밍 행위.</li>
            <li>미성년자에 대한 성적 권유 또는 미성년자와의 성적 접촉 시도를 조장하는 행위.</li>
          ...
          <ul className="list-disc pl-5 space-y-2 text-on-surface/80">
            ...
            <li>연관된 모든 위반 콘텐츠를 즉시 영구 삭제합니다.</li>
            <li>관련 법률에 따라 실시간 위반 계정 정보 및 IP 주소를 포함한 세부 정보를 실종아동학대방지센터(NCMEC) 및 관련 국제 사법 기관에 즉각 신고합니다.</li>
          </ul>

          <h2 className="text-xl font-bold text-primary uppercase tracking-wider">
            4. 앱 내 신고 기능 (In-App Reporting)
          </h2>
          <p className="leading-relaxed text-on-surface/80">
            Tango World는 사용하기 쉬운 앱 내 신고 도구를 제공합니다. 사용자는 사용자 프로필, 채팅 메시지 또는 커뮤니티 게시물에 있는 "신고" 버튼을 클릭하여 의심스러운 행동, 위반 콘텐츠 또는 아동 안전에 위협이 되는 요소를 즉시 신고할 수 있습니다. 미성년자 안전과 관련된 모든 신고는 최우선 순위로 처리되며 당사 안전 팀으로 직접 이관됩니다.
          </p>
