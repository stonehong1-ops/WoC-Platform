  ...
  try {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-surface text-center">
        ...
        <h1 className="text-2xl font-black text-on-surface mb-2">Unable to load information</h1>
        <p className="text-on-surface-variant max-w-sm mb-4">
          There was a problem fetching the data. This might be a temporary error, please try again later.
        </p>
