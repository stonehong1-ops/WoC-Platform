...
const CIRCLE_PATH = 0; // google.maps.SymbolPath.CIRCLE value is 0
...
export default function VenuesPage() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      const filtered = venueData.filter(v => {
        // Essential data check to prevent crash during render
  ...
  if (loadError) return <div className="p-10 text-center">Error loading maps.</div>;

  return (
    <PageWrapper>
      <div className="relative h-screen w-full overflow-hidden bg-[#f4fbfb] select-none -mt-16 sm:mt-0">
