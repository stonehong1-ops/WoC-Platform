    ...
    <div className="w-full px-4 py-6 bg-white space-y-4">
      ...
      <div className="text-xs text-gray-600 space-y-3 leading-relaxed">
        <div className="bg-red-50/50 border border-red-100 p-3 rounded-xl space-y-1.5">
          ...
          <p>
            • 취소 및 환불은 <strong className="text-red-700">2026년 8월 15일</strong>까지만 가능합니다.<br />
            • 2026년 8월 16일부터는 환불이 불가하며, 동일한 역할 신청자로 교체만 가능합니다.
          </p>
        </div>
        ...
        <div className="bg-red-50/50 border border-red-100 p-3 rounded-xl space-y-1.5">
          ...
          <p>
            • Cancellation and refund are available until <strong className="text-red-700">August 15, 2026</strong>.<br />
            • From August 16, 2026, refunds are not available. Replacement is only allowed with the same role.
          </p>
        </div>
      </div>
    </div>
