  ...
  return (
    <main className="max-w-md mx-auto min-h-screen pb-24 bg-white relative">
      ...
      <form onSubmit={handleSubmit} className="px-5 mt-4 space-y-6">
        ...
        {/* Hero Image */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-2 uppercase tracking-wider">{t('people.form_hero')}</label>
          <div
        ...
        {/* Profile Photo */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-2 uppercase tracking-wider">{t('people.form_profile')}</label>
        ...
        {/* Name */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_name')} <span className="text-red-400">*</span></label>
        ...
        {/* Sub Title */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_title')}</label>
        ...
        {/* Roles */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-2 uppercase tracking-wider">{t('people.form_roles')} <span className="text-red-400">*</span></label>
        ...
        {roles.includes('Couple') && (
          <div className="space-y-3 p-4 bg-[#f8f9fa] rounded-2xl border border-[#e0e4e5]">
            <p className="text-xs font-bold text-[#596061] uppercase tracking-wider">{t('people.form_partner_info')}</p>
        ...
        {/* Location */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_base_location')}</label>
          <div className="flex gap-3">
        ...
        {/* Current Location */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_current_location')}</label>
        ...
        {/* Bio */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_bio')}</label>
        ...
        {/* Languages */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_languages')}</label>
        ...
        {/* Booking Note */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-1.5 uppercase tracking-wider">{t('people.form_booking_note')}</label>
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            <label className="text-xs font-bold text-[#596061] uppercase tracking-wider">{t('people.form_tour_schedule')}</label>
        ...
        {/* Activity Flow */}
        <div>
          <label className="block text-xs font-bold text-[#596061] mb-3 uppercase tracking-wider">{t('people.form_activity_flow')}</label>
