    ...
    <div className="bg-white text-black antialiased">
      ...
      <header className="px-6 pt-24 pb-12 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-6xl md:text-8xl serif-text font-bold italic leading-none tracking-tight mb-8">Life goes ON_<span className="inline-block w-2.5 h-2.5 bg-[#4ade80] rounded-full ml-3 mb-1"></span></h1>
