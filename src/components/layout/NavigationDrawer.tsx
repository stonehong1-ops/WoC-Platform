              ...
              <div>
                ...
                {profile?.isAdmin && (
                  <>
                    ...
                    <Link href="/admin/lab/rhythm-training/rhythm-wheel" onClick={closeDrawer} className="flex items-center gap-4 px-5 py-2.5 text-on-surface/60 hover:bg-on-surface/[0.03] hover:text-on-surface rounded-2xl font-bold transition-all text-left">
                      <span className="material-symbols-outlined text-[20px]">music_note</span>
                      <span className="text-[15px] tracking-tight">Rhythm Wheel</span>
                    </Link>
