...
const GroupClassEditor: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <header className="px-6 py-6 w-full">
        ...
        <p className="text-[#515981] text-sm mt-1">Manage your group classes and schedules.</p>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-4 pb-20 w-full text-[#242c51]">
        ...
        <AnimatePresence>
          {activeSubEditor === "add-class" && (
            <GroupClassAddEditor onClose={() => setActiveSubEditor(null)} />
          )}
          {activeSubEditor === "discount" && (
            <GroupClassDiscountEditor onClose={() => setActiveSubEditor(null)} />
          )}
          {activeSubEditor === "monthly-pass" && (
            <GroupClassMonthlyPassEditor onClose={() => setActiveSubEditor(null)} />
          )}
        </AnimatePresence>
