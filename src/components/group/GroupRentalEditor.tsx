  ...
  return (
    ...
    >
      ...
      <header className="px-6 py-12 md:py-16 max-w-4xl mx-auto w-full">
        <h1 className="font-headline font-black text-3xl md:text-4xl tracking-tight text-[var(--on-surface)]">Rental Setting</h1>
        <p className="text-[var(--on-surface-variant)] text-base mt-2 font-medium">Configure base reservation and payment settings for your rental business.</p>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 flex flex-col gap-10 w-full">
        ...
        <section className="bg-white/70 backdrop-blur-md rounded-[32px] p-8 shadow-[var(--shadow-premium)] border border-white/80 transition-all hover:shadow-2xl hover:bg-white/90">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="font-headline font-black text-xl text-[var(--on-surface)]">Booking Method</h3>
          </div>
        ...
        <section className="bg-white/70 backdrop-blur-md rounded-[32px] p-8 shadow-[var(--shadow-premium)] border border-white/80 transition-all hover:shadow-2xl hover:bg-white/90">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-3 md:col-span-2">
              <label className="font-headline font-black text-[11px] uppercase tracking-[0.15em] text-[var(--on-surface-variant)] ml-1">Base Rate (per hour/day)</label>
              <div className="relative group">
        ...
        <section className="bg-white/70 backdrop-blur-md rounded-[32px] p-8 shadow-[var(--shadow-premium)] border border-white/80 transition-all hover:shadow-2xl hover:bg-white/90">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <label className="relative cursor-not-allowed opacity-50">
              <input disabled className="peer sr-only" name="rental-payment-method" type="radio" value="credit_card"/>
        ...
        <div className="pt-10">
          ...
          >
            {isUpdating ? "Saving..." : "Save Rental Setting"}
          </button>
        </div>
      </main>
    </motion.div>
