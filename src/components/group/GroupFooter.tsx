    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 md:gap-24">
      <div className="group-y-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.25em] text-primary mt-2 block">Premium Group</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-16 md:gap-32">
        <div className="group-y-8">
          ...
          <ul className="group-y-5 text-[11px] font-black text-on-surface-variant/70 uppercase tracking-[0.15em]">
