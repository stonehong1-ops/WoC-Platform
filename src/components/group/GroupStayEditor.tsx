...
const GroupStayEditor: React.FC = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <main className="pt-10 pb-20 px-4 md:px-8 max-w-4xl mx-auto group-y-6 w-full">
        {/* Editor Title */}
        <div className="mb-10">
        ...
        <section className="bg-white rounded-xl shadow-sm p-6 border border-[#a3abd7]/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group-y-2 md:col-span-1">
            ...
            <div className="group-y-2 md:col-span-2">
          ...
          <div className="group-y-8">
            ...
            <div className="bg-slate-50 rounded-lg p-5 border border-[#a3abd7]/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="group-y-1 md:col-span-2">
