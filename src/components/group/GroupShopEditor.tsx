...
import GroupShopAddEditor from "./GroupShopAddEditor";

const GroupShopEditor: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <header className="px-6 py-6 w-full">
        ...
        <p className="text-[#515981] text-sm mt-1">Manage your group items and sales.</p>
      </header>

      <main className="max-w-3xl mx-auto px-6 py-4 group-y-6 w-full">
        {/* Top Action Section */}
        ...
        <AnimatePresence>
          {activeSubEditor === "add-item" && (
            <GroupShopAddEditor onClose={() => setActiveSubEditor(null)} />
          )}
        </AnimatePresence>
