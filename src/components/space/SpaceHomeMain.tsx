...
const SpaceHomeMain = ({ community }: SpaceHomeMainProps) => {
  return (
    <div className="px-4 md:px-8 max-w-7xl mx-auto space-y-8 pb-32 pt-8">
      {/* Hero Section */}
      <section className="relative rounded-xl overflow-hidden shadow-sm aspect-video max-h-[400px] w-full group">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#020a2f]/80 via-transparent to-transparent flex flex-col justify-end p-6 md:p-8">
          ...
          <p className="text-[#f2f1ff]/90 font-body text-sm md:text-base max-w-2xl">Connect, dance, and express yourself in the heart of our community.</p>
        </div>
      </section>
      ...
      <section>
        <div className="flex justify-between items-end mb-6">
          ...
          <button className="text-[#0057bd] text-xs font-bold uppercase tracking-wide hover:underline">View Community</button>
        </div>
        <div className="space-y-4">
