...
interface SpaceHomeConfigProps {
  onClose: () => void;
  onSave?: () => void;
}

export default function SpaceHomeConfig({ onClose, onSave }: SpaceHomeConfigProps) {
  return (
    <motion.div
    ...
    >
      ...
      <main className="max-w-4xl mx-auto px-6 pt-8 space-y-12 pb-32">
          ...
          <div className="md:col-span-8 bg-white p-8 rounded-xl shadow-sm space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center bg-[#efefff] rounded-xl px-4 overflow-hidden focus-within:ring-2 focus-within:ring-[#0057bd]">
                <span className="text-[#515981] opacity-60 font-medium py-3">woc.today/space/</span>
                <input
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-20">
          ...
          <div className="md:col-span-8 space-y-4">
            <div className="space-y-6">
              {/* Service Item 1 */}
              <div className="bg-white p-6 rounded-xl shadow-sm space-y-4 border border-[#a3abd7]/10 relative group">
