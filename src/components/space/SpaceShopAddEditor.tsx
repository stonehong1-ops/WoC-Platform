...
interface SpaceShopAddEditorProps {
  onClose: () => void;
}

const SpaceShopAddEditor: React.FC<SpaceShopAddEditorProps> = ({ onClose }) => {
  return (
    <motion.div
    ...
    >
      ...
      <main className="max-w-3xl mx-auto p-6 space-y-8 mt-4 w-full">
        {/* Basic Info Section */}
        <section className="bg-white rounded-xl shadow-sm p-6 space-y-6 border border-[#a3abd7]/10">
          <div>
        ...
        {/* Images Section */}
        <section className="bg-white rounded-xl shadow-sm p-6 space-y-4 border border-[#a3abd7]/10">
        ...
        {/* Pricing */}
        <section className="bg-white rounded-xl shadow-sm p-6 space-y-6 border border-[#a3abd7]/10 mb-8 font-body">
...
export default SpaceShopAddEditor;
