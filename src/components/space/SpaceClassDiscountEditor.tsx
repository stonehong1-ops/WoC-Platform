...
interface SpaceClassDiscountEditorProps {
  onClose: () => void;
}

const SpaceClassDiscountEditor: React.FC<SpaceClassDiscountEditorProps> = ({ onClose }) => {
  return (
    <motion.div
    ...
    >
      {/* Top App Bar */}
      <header className="sticky top-0 z-50 bg-[#F1F5F9] px-6 py-4 flex items-center border-b border-outline/20">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-extrabold tracking-tight text-on-surface headline">Discount Editor</h1>
          </div>
      ...
      <main className="max-w-md mx-auto px-6 py-8 space-y-6 w-full">
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline/20 shadow-sm space-y-5">
          ...
          <div className="mt-5">
            <label className="block text-[10px] font-bold text-on-surface-variant mb-2 uppercase tracking-widest opacity-70" htmlFor="discount-details">Discount Description</label>
            <input 
              ...
              type="text" 
              defaultValue="20% discount for bundle classes"
            />
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline/20 shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              { title: "Vinyasa Core", schedule: "Fri • 12:00 PM", checked: false },
              { title: "Meditation & Breathwork", schedule: "Sun • 08:00 AM", checked: false },
            ].map((cls, idx) => (
...
export default SpaceClassDiscountEditor;
