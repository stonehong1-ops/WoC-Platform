      ...
      case 'Member':
        return (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white p-6 rounded-[32px] shadow-sm border border-slate-200/50 space-y-6">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                  <h2 className="text-xl font-extrabold tracking-tight text-[#242c51] font-headline">Member Directory</h2>
                  <p className="text-sm text-[#515981] mt-1">Manage and monitor active community members.</p>
                </div>
    ...
    <div className="p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          ...
          <nav className="flex items-center space-x-1 bg-slate-200/30 p-1 rounded-2xl w-fit">
