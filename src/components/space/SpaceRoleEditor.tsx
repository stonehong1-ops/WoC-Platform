...
interface SpaceRoleEditorProps {
  onClose: () => void;
}

const SpaceRoleEditor: React.FC<SpaceRoleEditorProps> = ({ onClose }) => {
  return (
    <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#515981] text-sm">Define the core hierarchy and access levels for your community.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-[#0057bd] group hover:shadow-md transition-shadow">
                ...
                <p className="text-[#515981] text-sm leading-relaxed mb-6">Full administrative access. Can manage billing, community settings, and delete the community.</p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-[#893c92] group hover:shadow-md transition-shadow">
                ...
                <p className="text-[#515981] text-sm leading-relaxed mb-4">Moderation and community management. Can view analytics and manage most member activities.</p>
            ...
            <div className="mt-8 bg-[#efefff] rounded-2xl p-8">
              ...
              <div className="space-y-4">
                {/* Toggle 1 */}
                {[
                  { icon: "post_add", label: "Manage posts", desc: "Edit, delete, or pin any community post", checked: true },
                  { icon: "person_search", label: "Manage members", desc: "Invite, kick, or ban members from the community", checked: true },
          ...
          <div className="lg:col-span-4">
            <div className="bg-white rounded-2xl p-6 shadow-[0_8px_24px_rgba(36,44,81,0.04)] sticky top-28">
              ...
              <div className="space-y-6">
                {[
                  { name: "Sarah Jenkins", role: "Community Lead", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCl30bOWbj8eu5-5mksyArDh9zEdWo8VmV5_xHkvDg9-nCe9Fo3CfoUyER8UzM8Dr35FK0jFxhGaEUpuJT2Wd4rBxPfRJsGpd_sh8Y6p2MQyMBhMy6WXHDSYvUMPmqxbq5y_F-wU2ucel_EPeF-7g07WuJuA-6AhoD1qa_wlD_D3yUgRuTz0plwWETzDkCWeOmr94-oaDK3vyEj4KK1Y0Vju2vHOSz4Wgvfiwo3xUHbB6t8Kct70p5tECR5odLCS3qIhuu_YI_I3XA" },
